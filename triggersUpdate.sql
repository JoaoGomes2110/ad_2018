Use `northwind`;
DROP TRIGGER IF EXISTS trigger_update_customers;
DELIMITER $$
...
DROP TRIGGER IF EXISTS trigger_update_shipper;
DELIMITER $$
CREATE TRIGGER trigger_update_shipper
...
DROP TRIGGER IF EXISTS trigger_update_supplier;
DELIMITER $$
...
DROP TRIGGER IF EXISTS trigger_update_products;
DELIMITER $$
