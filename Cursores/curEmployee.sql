...
begin
    ...
    insert into dim_employee(id_dim_employer,company,first_name_last_name,job_title,city,state_province,country_region) values(aux_id,aux_company,aux_name,aux_job_title,aux_city,aux_state_province,aux_country_region);
    end loop;
    close cur;
end 
$$
